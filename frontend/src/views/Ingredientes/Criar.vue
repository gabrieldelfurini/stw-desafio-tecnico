    ...
    <div class="container mt-5">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="mb-3">
                    <button type="button" @click="salvarIngrediente" class="btn btn-primary" >Save</button>
                </div>
            </div>
        </div>    
    </div>    
    ...
    export default {
        ...
        methods: {
            salvarIngrediente(){
                ...
                var mythis = this;
                axios.post('http://127.0.0.1:8000/api/ingredientes', this.model.ingrediente)
                    .then(res => {
                    ...
                    .catch(function (error) {
                        ...
                        if (error.response) {
                            ...
                            if(error.response.status == 422){
                                ...
                                // console.log('entrou: ', this.errorList)
                            }
